...
* wxWidgets >= 3.0
    * Download wxWidgets: `wget https://github.com/wxWidgets/wxWidgets/releases/download/v3.1.3/wxWidgets-3.1.3.tar.bz2`
    * Unzip the file: `tar -xvf wxWidgets-3.1.3.tar.bz2`
    * `cd wxWidgets-3.1.3`
    * Make a build directory in the top level directory: `mkdir gtk-build && cd gtk-build`
    * `../configure --disable-shared --enable-unicode`
    * `sudo make install`
    * Or you can do: `sudo apt-get install libwxgtk3.0-dev libwxgtk3.0-0v5-dbg`
  
## Basic Build Instructions

1. Clone the repository: `clone https://github.com/PooyaAlamirpour/Chatbot.git`
